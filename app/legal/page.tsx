...
export default function LegalPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 space-y-12">
      <section>
        <AnimatedTextMask as="h1" className="text-3xl sm:text-4xl font-bold" lines={["Privacy Policy"]} />
      ...
      <section>
        <AnimatedTextMask as="h2" className="text-2xl font-semibold" lines={["Terms & Conditions"]} />
        <p className="mt-3 text-muted-foreground">
