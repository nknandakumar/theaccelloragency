    ...
    <section className="py-24 sm:py-28 bg-[#050505] text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <header className="mb-12 sm:mb-14">
          <AnimatedTextMask
            as="h2"
            className="mt-3 text-4xl lg:text-7xl lg:leading-tight max-w-5xl mx-auto text-start uppercase tracking-tight font-extrabold text-black dark:text-white"
        ...
        <div className="space-y-8 sm:space-y-10">
          {featured.map((project, idx) => (
            <RevealOnScroll key={project.slug} delay={idx * 0.12}>
              <article className="flex flex-col lg:flex-row gap-6 sm:gap-8 rounded-3xl bg-[#0b0b0b] border border-white/5 overflow-hidden">
