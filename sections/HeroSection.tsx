...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden min-h-screen">
      ...
      <div  className="mx-auto max-w-6xl  px-4 pt-12 sm:pt-18 text-center max-[375px]:text-left">
        ...
        <h1 className="mt-6 text-3xl sm:text-7xl font-semibold tracking-tight tracking-wide max-w-3xl mx-auto max-[375px]:mx-0">
        ...
        <p className="mt-6 text-base text-white/70 max-w-2xl mx-auto max-[375px]:mx-0">
